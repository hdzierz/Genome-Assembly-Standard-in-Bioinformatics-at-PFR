...
- Indices
- Linkage maps if used during scaffold assignment and if not otherwise included in another Git repo oth(Linkage maps (if used during scaffold assignment) in standard format or links to maps in Git